...
void Simulator::calculateLengthEnergyGradient(int i) {
  ...
  gradE(index + 0) += coefficient * integrate<float>([&](float s)->float {
    DECLARE_BASIS_D(b, s);
    return (bD1 * (sqrt(pow(bD1 * px1 + bD2 * px2 + bD3 * px3 + bD4 * px4, 2.0) 
      + pow(bD1 * py1 + bD2 * py2 + bD3 * py3 + bD4 * py4, 2.0)
      + pow(bD1 * pz1 + bD2 * pz2 + bD3 * pz3 + bD4 * pz4, 2.0)) / L - 1.0) * 1.0 
      / sqrt(pow(bD1 * px1 + bD2 * px2 + bD3 * px3 + bD4 * px4, 2.0)
        + pow(bD1 * py1 + bD2 * py2 + bD3 * py3 + bD4 * py4, 2.0)
        + pow(bD1 * pz1 + bD2 * pz2 + bD3 * pz3 + bD4 * pz4, 2.0))
      * (bD1 * px1 + bD2 * px2 + bD3 * px3 + bD4 * px4) * 2.0) / L;
    }, 0, 1);
